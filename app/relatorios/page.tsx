...
export default async function ReportsPage() {
  ...
  const hours = monthEntries.reduce((s: number, e: any) => s + Math.max(0, Number(e.hours_worked) || 0), 0);
  ...
  const costPerKm = km > 0 ? costs / km : null;
